...
<body class="">
  <div class="container-fluid bg d-flex justify-content-center">
    <div class="row  ">
      ...
      <div class="col-md-12 p-5 text-center sticky-center"> <a href="index.php" target=""> <img src="../assets/games/match_words/images/playbtn.png" style="max-height: 200px;" class="img-fluid" alt=""> </a> </div>
    </div>
  </div>
  <!-- Modal -->
