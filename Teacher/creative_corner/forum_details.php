            ...
            <div class="row">
                ...
                if ($subtopicsResult->num_rows > 0) {
                    while ($subtopicRow = $subtopicsResult->fetch_assoc()) {
                        ...
                        echo '<div id=forum_details class="container-fluid shadow p-3 h-100 d-flex flex-column rounded border" onclick="redirectToPage(' . $forumId . ', ' . $subtopicRow['kidzpost_id'] . ')">';
