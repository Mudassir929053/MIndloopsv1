                        ...
                        <table class="table align-middle">
                            ...
                            <tbody id="communityTable">
                                ...
                                while ($communityRow = mysqli_fetch_assoc($communityResult)) {
                                    ...
                                    echo '<td>';
                                    if ($categoryCount > 0) {
                                        echo '<a href="community-article.php?community_id=' . $communityId . '&category_id='.$category_id.'" class="text-warning">' . $communityName . '</a>';
                                    } else {
                                    ...
                                    if ($categoryCount > 0) {
                                        echo '<a href="community-article.php?community_id=' . $communityId . '&category_id='.$category_id.'"><span class="badge bg-primary rounded-pill">View Community</span></a>';
                                    } else {
