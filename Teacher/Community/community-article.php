                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-12 offset-lg-0  p-5 container" style="background: url('../../assets/community/pngfiles/Maskgroup-2.png'); background-repeat: no-repeat; background-position: right; background-size: 34%; ">
                                ...
                                <a href="add-article.php?category_id=<?= $_GET['category_id'] ?>&community_id=<?= $_GET['community_id'] ?>" class="btn-sm px-5">
                                <img src="../../assets/community/pngfiles/Group411.png" alt="Video_thumbnail" style="border-radius: 0;" class="btn btn-sm">
                            </a>
                            </div>
                    ...
                    while ($categoryRow = mysqli_fetch_assoc($categoryResult)) {
                        ...
                        if (mysqli_num_rows($articleResult) > 0) {
                            ...
                            $thumbnailPath = "default-thumbnail.jpg";
                                ...
                                echo '<div class="">';
                                echo '<img src="../'.$thumbnailPath.'" class="card-img-top" alt="Article Thumbnail" style="height: 200px; border-radius: 10px;">';
                                ...
                                echo '<a href="view_comments.php?article_id=' . $articleRow['article_id'] . '&category_id='.$categoryRow['category_id'].'&community_id='.$community_id.'" class="text-black"><h5 class="card-title text-dark">' . $articleRow['ca_title'] . '</h5></a>';
