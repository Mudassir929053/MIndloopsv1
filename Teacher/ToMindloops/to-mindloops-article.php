                ...
                <div class="container-fluid my-5">
                    ...
                    <div class="row">
                       ...
                       $user = $_SESSION['u_id'];
                                        ...
                                        <div class="row g-0">
                                            <div class="col-4">
                                                <a href="view-article.php?article_id=<?= $communityId ?>">
                                                    ...
                                                    <?php } else { ?>
                                                        <img src="thumbnails/<?= $article_thumbnail ?>" class="card-img-top" alt="Article Image">
                                                    <?php } ?>
                                                </a>
                                            </div>
                                            <div class="col-8">
                        ...
                        $totalArticlesQuery = "SELECT COUNT(*) AS total FROM `to_mindloops_articles` LEFT JOIN tb_users ON tb_users.u_id = to_mindloops_articles.created_by WHERE topic_id = '$to_mindloops_id'";
