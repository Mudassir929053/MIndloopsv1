...
<main>
    <div class="container">
        <a href="manage-ready-to-go-lesson.php" class="btn btn-warning col-lg-2 my-5">Back</a>
        <h1>LESSONS</h1>
        <br>
        <?php
                            ...
                            <div class="card-body d-flex flex-column align-items-center justify-content-center <?php echo ($isBlurred && !$isPremiumUser) ? 'blurred' : ''; ?>" style="background-color: #F5F5F5;">
                                <div style="height: 200px; display: flex; align-items: center; justify-content: center; position: relative;">
                                    <?php if ($isBlurred) { ?>
                                        ...
                                        <?php if (!$isPremiumUser) { ?>
                                            ...
                                            <button type="button" class="btn text-white btn-sm center-button premium-button" data-bs-toggle="modal" data-bs-target="#premiumModal" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: #E91E63;">Premium 🔒</button>
                                        <?php } ?>
                                    <?php } else { ?>
                                ...
                                <?php if ($isBlurred) { ?>
                                    <a href="#" class="text-center btn btn-warning btn-sm mt-3">
                                        <span class="text-black font-weight-bold" data-bs-toggle="modal" data-bs-target="#premiumModal" style="font-size: 18px; filter: blur(5px);"><?php echo $l_name; ?></span>
                                    </a>
