...
<main>
  <div class="container">
    <!-- <a href="manage-mindbooster.php" class="btn btn-warning col-lg-2 my-5">Back</a> -->
    <br>
    <?php
    ...
    ?>
      <a href="lesson.php?mb_id=<?php echo $mb_id; ?>&grade=<?php echo $level; ?>" class="btn btn-warning" id="back-button" style="margin-left: 15px;"><i class="bi bi-arrow-left"></i>Back</a>
      <div class="d-flex justify-content-center p-5">
        <div class="col-lg-9 d-flex justify-content-center">
          <div class="card col-md-12 p-5 border-0 shadow">
            <div class="card-body">
              ...
              <?php if (!empty($lessonPlan)) { ?>
                <div class="btn-group p-1" role="group">
                  <a href="../<?php echo $lessonPlan; ?>" class="btn btn-success " target="_blank">lesson Plan</a>
                </div>
              <?php } ?>

              <?php if (!empty($worksheet)) { ?>
                <div class="btn-group p-1" role="group">
                  <a href="../<?php echo $worksheet; ?>" class="btn btn-warning " target="_blank">Worksheet</a>
                </div>
              <?php } ?>
              ...
              <?php if (!empty($exercise)) { ?>
                <div class="btn-group  p-1" role="group">
                  <a href="../<?php echo $exercise; ?>" class="btn btn-success" target="_blank">Exercise</a>
                </div>
              <?php } ?>
              <?php if (!empty($quiz)) { ?>
                <div class="btn-group  p-1" role="group">
