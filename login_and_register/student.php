      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="cards">
          ...
          <div class="card" id="rightGrid">
            ...
            <p>Discover fun ways to learn and explore with your family at the tip of the finger.</p>
            <button id="discoverFamilyP" onclick = "document.location='../subscription/singlePackagePage.html'">Discover Educators Package</button>
                ...
                $.ajax({
                    ...
                    success: function (output, status, xhr) {
                        ...
                        if (result.subscribedStatus == true) {
                            ...
                            window.location.href = "../manageSubscription/student_subscribe.html";
