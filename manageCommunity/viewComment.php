        ...
        <div class="row gy-4">
          ...
          <form id="insertLpForm" action="#" onsubmit="return updateComment(this)" method="POST" enctype='multipart/form-data'>
            ...
            <div class="form-group"> 
                ...
                <textarea class="form-control" name="ca_desc" placeholder="Enter Community description..." maxlength="1000" required><?= $data['comment_content'] ?></textarea>
            </div>
            <br>  
...
<script>
  ...
  function updateComment(obj){
        ...
        let url = 'communityQuery.php?updateComment=yes&comment_id=';
        fetch(url,{
            method: 'POST',
            body: formData
            ...
            if(data=='Updated successfully'){
                window.location.href = 'manageComments.php?ca_id=<?= $ca_id ?>';
            }
        });
        return false;
