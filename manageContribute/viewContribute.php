            ...
            <div class="card-body">
                ...
                <form id="viewContribution">
                    <div class="row row-space">
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                <label class="label">Type of Contribution</label>
                                <input class="input--style-4" type="text" name="c_type" disabled>

                            </div>
                        </div>
                        <!-- <div class="col-6">
                                <div class="rs-select2 js-select-simple select--no-search">
                                    <select name="package_type" id="package_type" disabled>
                                        
                                            <option id="two" value="two">Family Package</option>
                                            <option id="one" value="one">Single Package</option> 
                                    </select>
                    ...
                    <div class="row row-space">
                        ...
                        <div class="col-12">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="text" name="c_title" disabled>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="input-group">
                                <label class="label">Description</label>
                                <textarea class="input--style-4" style="border: none;outline: none;" id="c_desc" name="c_desc" rows="4" cols="55" disabled></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row row-space">
                        <div class="col-6">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="text" name="c_date" disabled>
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="text" name="c_author" disabled>
...
<script>
    ...
    $(document).ready(function() {
        ...
        if (urlParams.has('c_id')) {
            const id = urlParams.get('c_id');
            $.ajax({
                type: "get",
                url: "getContributeDetails.php?c_id=" + id,
                success: function(contribute, status, xhr) {
                    console.log(contribute);
                    $('input[name=c_title]').val(contribute.title);
                    //$('input[name=c_desc]').val(contribute.desc);
                    $("#c_desc").val(contribute.desc);
                    $('input[name=c_date]').val(contribute.date);
                    $('input[name=c_author]').val(contribute.author);
                    $('input[name=c_type]').val(contribute.contentType);
                    if (contribute.file != "") {
