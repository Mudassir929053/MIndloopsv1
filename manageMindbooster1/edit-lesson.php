    ...
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-12">
          ...
          ?>
          <form id="editLessonForm" action="edit-lesson-backend.php" method="POST" enctype="multipart/form-data">
            ...
            <br>
            <div class="form-group">
              <label for="l_created_date">Created Date</label>
              <?php
              // Assuming that $l_created_date is in the format 'Y-m-d'
              $createdDate = date('Y-m-d', strtotime($l_created_date));
              ?>
              <input type="date" class="form-control" id="l_created_date" name="l_created_date" value="<?php echo $createdDate; ?>" required>
            </div>
            <br>
            <div class="form-group">
