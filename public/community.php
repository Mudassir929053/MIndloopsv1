                    ...
                    <table class="table align-middle">
                        ...
                        <tbody id="communityTable">
                            ...
                            while ($communityRow = mysqli_fetch_assoc($communityResult)) {
                                ...
                                $categoryQuery = "SELECT COUNT(`category_id`) AS `category_count` FROM `community_category` WHERE `community_id` = $communityId";
                                ...
                                echo '<td><a href="community-category.php?community_id=' . $communityId . '">' . $communityName . '</a></td>';
                                ...
                                echo '<td class="align-middle"><a href="community-article.php?community_id=' . $communityId . '"><span class="badge bg-primary rounded-pill">View Community</span></a></td>';
                                echo '</tr>';
