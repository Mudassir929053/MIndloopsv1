...
<main id="main">
    ...
    <section id="portfolio-details" class="portfolio-details">
        <div class="container">
        <h2 style="text-align: center; font-size: 36px; color: #ff6f00; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">Kidz Forum</h2>
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        $sql = "SELECT * FROM `forum` WHERE published=1 and forum_for='Kids'";
                        ...
                        ?>
                                <div class="col-md-12">
                                    <div class="forum-item">
                                        <h5><i class="fa fa-newspaper-o"></i><a href="kidz_forum_details.php?forum_id=<?php echo $row['forum_id'] ?>"><?php echo $row['forum_name'] ?></a></h5>
                                    </div>
                                </div>
                        <?php
                            }
