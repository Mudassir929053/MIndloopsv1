        ...
        ?>
                <div class="row p-md-5">
                    ...
                    <div class="col-md-1 offset-md-4 px-md-4">
                        ...
                        <div class="dropdown">
                            <i class="bi bi-bookmark" data-toggle="modal" data-target="#globalModal"></i>
                            
                                <button class="btn btn-link" type="button" data-toggle="modal" data-target="#globalModal" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="row">
            ...
            ?>
                        ...
                        <div class="container mb-md-5">
                            ...
                            <div class="row">
                                <div class="col py-3 d-flex justify-content-between">
                                    <div>
                                        <button class="like-button border-0 bg-white" style="color:rgb(49, 215, 185)" data-toggle="modal" data-target="#globalModal"><i class="fa fa-thumbs-up"></i> <span id="a_likes"><?php echo $subtopicRow['likes']; ?></span></button>
                                        <button class="dislike-button border-0 bg-white" style="color:rgb(236, 44, 72)" data-toggle="modal" data-target="#globalModal"><i class="fa fa-thumbs-down"></i> <span id="a_dislikes"><?php echo $subtopicRow['dislikes']; ?></span></button>
                                        <button href="#" class="add-comment border-0 px-md-3 py-md-2 rounded-pill" data-toggle="modal" data-target="#globalModal">
                                    ...
                                    <div>
                                        ...
                                        $commentCountQuery = "SELECT COUNT(*) AS comment_count FROM forum_postcomment WHERE subforumtopic_id = $forumtopic_id ";
                ...
                $commentsQuery = "SELECT fc.comment_id, fc.content, fc.created_at, tu.u_name, likes, dislikes, created_by
                  ...
                  WHERE fc.subforumtopic_id = $forumtopic_id AND approved='1'
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-2 offset-md-7 py-1">
                                        <div class="dropdown d-flex justify-content-end">
                                            <button class="like-button border-0 bg-light" style="color:rgb(49, 215, 185)" data-toggle="modal" data-target="#globalModal"><i class="fa fa-thumbs-up"></i><?= $commentRow['likes'] ?></button>
                                            <button class="dislike-button border-0 bg-light" style="color:rgb(236, 44, 72)" data-toggle="modal" data-target="#globalModal"><i class="fa fa-thumbs-down"></i><?= $commentRow['dislikes'] ?></button>
