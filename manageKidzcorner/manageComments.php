...
<script>
  ...
  xhr.open("get", "./kidzcornerQuery.php?allComments_kidz_posts=yes&kidzpost_id=<?= $kidzpost_id ?>");
  ...
  xhr.onload = function(){
    ...
    for(var i=0; i<jsonData.length; i++){
      ...
      aView.setAttribute("href","viewComment.php?comment_id=" + jsonData[i].comment_id+"&kidzpost_id="+jsonData[i].kidzpost_id);
      ...
      aDlt.setAttribute("href","managecomments.php?kidzpost_id="+jsonData[i].kidzpost_id);
