...
$sql = "SELECT A.*, B.u_name as owner FROM kidzpost A join tb_users B on A.created_by = b.u_id where kidzpost_id = '$kidzpost_id'";
$data=[];
    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <a href="#" onclick="history.back()" class="btn btn-warning col-lg-1"><i class="bi bi-arrow-left"></i> Back</a>
