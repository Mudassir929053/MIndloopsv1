...
$img_category = '';
    ...
    if(isset($_FILES['image'])) {
      ...
      if(in_array($file_ext, $allowed_ext)) {
          ...
          $image_path = '../../assets/games/match_words/uploads/' . $image_name;
  ...
  if(isset($_FILES['category_image'])) {
      ...
      if(in_array($file_ext, $allowed_ext)) {
          ...
          $img_path = '../../assets/games/match_words/uploads/' . $img_name;
...
if (isset($_GET["dm_delete_word"])) {
    ...
    $stmt = $conn->prepare("SELECT `image_url`, `img_category` FROM `tb_wordmatch` WHERE `id` = ?");
    $stmt->bind_param("i", $dm_delete_word);
    $stmt->execute();
...
if (isset($_POST['edit_word_picture'])) {
    ...
    $sql = "SELECT * FROM tb_wordmatch WHERE id = '$id'";
    $result = mysqli_query($conn, $sql);
    ...
    if ($_FILES['image']['name']) {
        ...
        $image_url = '../../assets/games/match_words/uploads/' . $image_name;
