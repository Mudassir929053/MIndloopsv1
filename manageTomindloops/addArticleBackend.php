...
date_default_timezone_set("Asia/Kuala_Lumpur");
    ...
    if($conn){
    $admin = $_SESSION['u_id'];
    $sql = "INSERT INTO to_mindloops_articles(topic_id,article_title,article_content,created_by,attachment) VALUES (?,?,?,?,?)";
    ...
    if (mysqli_stmt_execute($stmt)){
        ...
        header("Location: tomindloopsArticles.php?topic_id=".$topic_id);
