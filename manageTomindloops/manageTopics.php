...
<!-- 
    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <h2 style="text-align: center;">To Mindloops Topics</h2>
...
<script>
  ...
  xhr.open("get", "./communityQuery.php?allTopics=yes");
  ...
  xhr.onload = function(){
    ...
    for(var i=0; i<jsonData.length; i++){
      ...
      aView.setAttribute("href","toMindloopsArticles.php?topic_id=" + jsonData[i].to_mindloops_topic_id);
      ...
      aEdit.setAttribute("href","editTopic.php?topic_id=" + jsonData[i].to_mindloops_topic_id);
      ...
      aDlt.setAttribute("href","toMindloopsArticles.php");
      aDlt.setAttribute("onclick","return deleteTopic('" + jsonData[i].to_mindloops_topic_id + "','"+jsonData[i].topic_name+"');");
