...
<!-- 
    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <h2 style="text-align: center;">Articles -> <?= $topic_name ?></h2>

        <br>

        <div class="row gy-4">

          <a href="addArticle.php?topic_id=<?=$topic_id?>&cc_name=<?= $topic_name ?>" class="btn btn-warning col-lg-2"><i class="bi bi-plus-circle"></i> Add Article</a>
...
<script>
  ...
  xhr.open("get", "./communityQuery.php?tomindloopsArticles=yes&topic_id=<?= $topic_id ?>");
  ...
  xhr.onload = function(){
    ...
    for(var i=0; i<jsonData.length; i++){
      ...
      tdTitle.innerHTML = jsonData[i].article_title;
      ...
      aView.setAttribute("href","viewArticles.php?article_id=" + jsonData[i].article_id+"&topic_id=" + jsonData[i].topic_id);
      ...
      aEdit.setAttribute("href","editarticle.php?article_id=" + jsonData[i].article_id+"&topic_id=" + jsonData[i].topic_id);
      ...
      aDlt.setAttribute("href","communityArticles.php?");
      aDlt.setAttribute("onclick","return deleteArticle('" + jsonData[i].article_id + "','"+jsonData[i].article_title+"');");
