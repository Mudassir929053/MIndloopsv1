      ...
      <div class="col-md-10">
        <div class="container-fluid mb-3">
          <div class="row d-flex justify-content-center">
              ...
              <div class="col-lg-1 border-start border-danger border-2 bg-white col-12" style="padding-left:20px;">
                ...
                <div id="accordionExample">
                  ...
                  while ($year_row = mysqli_fetch_assoc($year_result)) {
                    $year = $year_row['year'];
                    $months = array();
                    $endMonth = ($isPremiumUser) ? 12 : 6;
                    // Loop through each month for the current year
                    for ($month = 1; $month <= $endMonth; $month++) {
                      $month_query = "SELECT COUNT(*) as total, MONTH(m_rDate) as month_num
                      FROM tb_magazines
                      WHERE YEAR(m_rDate) = $year
                      GROUP BY month_num
                      ORDER BY month_num";
            ...
            $rows_per_page = $isPremiumUser ? 12 : 6; // set the number of rows to display per page
            ...
            $query = $conn->query("SELECT * FROM `tb_magazines` ORDER BY m_rDate DESC");
                ...
                <div class="container-fluid">
                  <div class="row mt-3">
                    ...
                    while ($rows = mysqli_fetch_object($query)) {
                      ...
                      if ($isPremiumUser || ($month >= 1 && $month <= 6)) {
                        $image_count++;
