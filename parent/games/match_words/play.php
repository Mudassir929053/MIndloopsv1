...
<head>
  ...
  <?php
if ($level == 'Easy') {
  $cssLink = '/mindloops/assets/games/match_words/css/easy.css';
} else if ($level == 'Medium') {
  $cssLink = '/mindloops/assets/games/match_words/css/medium.css';
} else if ($level == 'Hard') {
  $cssLink = '/mindloops/assets/games/match_words/css/hard.css';
}
