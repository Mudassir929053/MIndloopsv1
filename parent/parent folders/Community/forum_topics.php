...
<style>
    ...
    .list:hover {
    transform: scale(0.9);
    background-color: #f2f2f2; /* Add a background color for the hover effect */
}
    .list a:hover {
        color: blue;
    }
...
<main id="main">
    <div class="container-fluid">
        ...
        $subtopic = "SELECT * FROM `community_article` WHERE `category_id` = $category_id and `article_id` = $article_id";
        ...
        ?>
                <div class="row p-md-5">
                    ...
                    <div class="col-md-1 offset-md-4 px-md-5">
                        <?php
                            ...
                            <div class="row">
                                <div class="col py-3 d-flex justify-content-between">
                                    ...
                                    <div>
                                        ...
                                        $commentCountQuery = "SELECT COUNT(*) AS comment_count FROM forum_postcomment WHERE subforumtopic_id = $forumtopic_id And approved='1'";
