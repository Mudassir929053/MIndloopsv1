                                        ...
                                        <div class="row">
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo '<video controls  loop controls controlsList="nodownload" src="../' . $row['v_path'] . '" title="YouTube video" alt="" class="img-fluid mindbooster-img ' . $isPremium . '" allowfullscreen></video>';
