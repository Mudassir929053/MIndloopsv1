                    ...
                    <table class="table align-middle">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle">Total Articles</th>
                        ...
                        <tbody id="communityTable">
                            ...
                            while ($communityRow = mysqli_fetch_assoc($communityResult)) {
                                ...
                                $categoryQuery = "SELECT COUNT(`topic_id`) AS `category_count` FROM `to_mindloops_articles` WHERE `topic_id` = $communityId AND created_by = $userID";
