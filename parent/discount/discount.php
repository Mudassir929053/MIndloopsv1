          ...
          <div class="row">
            <div class="col">
              <ul class="nav nav-pills justify-content-center text-uppercase mt-3" id="category-tabs" role="tablist">
                <li class="nav-item">
                  <a class="nav-link1 active" id="category-all-tab" data-toggle="pill" href="#category-all">All</a>
                </li>
                <?php
                // Generate the category tabs dynamically
                foreach ($categories as $category) {
                  echo '<li class="nav-item">
                  <a class="nav-link1" id="category-' . $category['discount_category'] . '-tab" data-toggle="pill" href="#category-' . $category['discount_category'] . '">' . $category['discount_category'] . '</a>
                </li>';
                }
                ?>
              </ul>
                  ...
                  <div class="col mb-4" style="cursor: pointer;" onclick="window.location='collect_coupon.php?discount_id=<?php echo $discount_id; ?>'">
                    <div class="card h-100">
                      ...
                      <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <p class="card-text text-info"><?php echo $description; ?></p>
                      </div>
                    </div>
                  </div>
              <?php
                  // $counter++;
                  // if ($counter == 3) {
                  //   break; // Exit the loop after displaying three cards
                  // }
                }
              } else {
                echo '<div class="col">😔 Sorry, no discounts available at the moment.</div>';
              }
              ?>
            </div>
          </div>
