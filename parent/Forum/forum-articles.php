    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-6 px-5 p-5 container">
                ...
                <a href="addarticle.php?forum_id=<?php echo $forumID; ?>" class="btn-sm">
                                            ...
                                            <div class="card-body p-0">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <p class="card-text text-muted small"><?php echo $ftDate; ?><?php echo $current_user_id; ?></p>
                                                        <p class="card-text text-dark small"><?php echo $ftDescriptionShort; ?>...</p>
                                                    </div>
                                                    <?php if ($created_by == $current_user_id) {
                                                        // Display update and delete buttons for comments created by the current user
                                                    ?>
                                                        <div class="col-md-1 text-end">
                                                            <div class="dropdown dropdown-menu-right">
                                                                <button class="btn btn-link text-dark" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
