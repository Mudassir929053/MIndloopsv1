    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <a href="forum-category.php?forum_id=<?= $forum_id ?>" class="btn btn-warning col-lg-1"><i class="bi bi-arrow-left"></i> Back</a>
          ...
          <form id="insertLpForm" action="addtopicBackend.php" method="POST" enctype="multipart/form-data">
            ...
            <br>       
            <div class="form-group"> 
                <label for="ft_image">Image</label>
                <input type="file" class="form-control" id="ft_image" name="ft_image"  required>
            </div>
            <br>
            <div class="form-group">
