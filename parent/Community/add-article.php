        ...
        <section id="portfolio-details" class="portfolio-details">
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <a href="community-article.php?community_id=<?= $_GET['community_id'] ?>&category_id=<?= $_GET['category_id'] ?>" class="btn btn-warning btn-sm col-lg-1 mx-5"><i class="bi bi-arrow-left"></i> Back</a>
                    <div class="col-lg-12">
