    ...
    <div class="wrapper wrapper--w680">
        <div class="card card-4">
            <div class="card-body">
                ...
                <h2 class="title">Update Teaching Support </h2>
                <form id="updateTeachSupport" method="POST" action="updateTeachSupportDB.php" enctype="multipart/form-data">
                    ...
                    <div class="row row-space">
                        <div class="col-12">
                            <input class="input--style-5" type="text" name="ts_id" style="display:none">
                    ...
                    <div class="p-t-15">
                        <button class="btn btn--radius-2 " id="btn--addNewPackage" type="submit">Edit</button>
                    </div>
            </div>
        </div>
        </form>
