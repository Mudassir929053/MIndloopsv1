...
<main>
  <div class="container">
    ...
    ?>
      <a href="lesson.php?mb_id=<?php echo $mb_id; ?>&grade=<?php echo $level; ?>" class="btn btn-warning" id="back-button" style="margin-left: 15px;"><i class="bi bi-arrow-left"></i> Return lessons</a>
      <div class="container">
      <div class="d-flex justify-content-center p-5">
        <div class="col-lg-12 d-flex justify-content-center">
          <div class="card col-lg-12 p-5 shadow" style="background-color: cornsilk;">
            <div class="card-body">
              ...
              <?php if (!empty($lessonPlan)) { ?>
                <!-- <div class="btn-group" role="group">
                  <a href="<?php echo $lessonPlan; ?>" class="btn btn-info" target="_blank">Lesson Plan</a>
                </div> -->
              <?php } ?>
              ...
              <?php
                $file_name = '';
              if (!empty($supplementaryNote)) { 
                  $files_arr = explode('/',$supplementaryNote);
                  $file_name = end($files_arr);
                  
                
                ?>
                <div class="btn-group" role="group">
                  <a href="#" onclick="viewPpt('<?php echo $supplementaryNote; ?>')" class="btn btn-warning">Supplementary Note</a>
                </div>
              <?php } ?>
              ...
              <?php if (!empty($exercise)) { ?>
                <div class="btn-group" role="group">
                  <a href="<?php echo $exercise; ?>" class="btn btn-danger" target="_blank">Exercise</a>
                </div>
              <?php } ?>
            </div>
            <div id="iframe" style="display: none;">
              <?php if($file_name != ''){
                ...
                ?>
            <iframe src='https://view.officeapps.live.com/op/embed.aspx?src=<?= $baseUrl ?>/assets/mindbooster/lessons/<?= $file_name ?>' width='100%' height='1000' frameborder='0'></iframe>
              <?php } ?>
        </div>
          </div>
        </div>
