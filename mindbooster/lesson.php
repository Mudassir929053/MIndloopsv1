...
<main>
    <div class="container">
        <a href="mindbooster.php" class="btn btn-warning col-lg my-5">Go Back</a>
        <h1>LESSONS</h1>
        <br>
        <?php
                            ...
                            <div class="card-body d-flex flex-column align-items-center justify-content-center <?php echo ($isBlurred && !$isPremiumUser) ? 'blurred' : ''; ?>" style="background-color: #F5F5F5;">
                                ...
                                <?php if ($isBlurred) { ?>
                                    <a href="#" class="text-center btn btn-warning btn-sm mt-3">
                                        <span class="text-black font-weight-bold" data-toggle="modal" data-target="#premiumModal" style="font-size: 18px; filter: blur(5px);"><?php echo $l_name; ?></span>
                                    </a>

                                <?php } else { ?>
                                    <a href="lesson_view.php?l_id=<?php echo $l_id; ?>&mb_id=<?php echo $mb_id; ?>&grade=<?php echo $level; ?>" class="text-center btn btn-warning btn-sm mt-3" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
